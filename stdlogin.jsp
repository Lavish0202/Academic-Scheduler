<%-- 
    Document   : stdlogin
    Created on : 30 Jan, 2018, 4:20:58 PM
    Author     : HP Laptop
--%>
...
<nav class="navbar navbar-inverse" data-spy="affix" data-offset-top="197">
  ...
  <form method="post" action="validatelogin.jsp">
      ...
      <input type="text" class="form-control" style="width: 50%;" id="name" name="name" required="">
    </div>
          <label for="mail"  >Email:</label>
      <input type="email" class="form-control" style="width: 50%;"id="mail" placeholder="0876IT151001@medicaps.ac.in" name="mail" required="">
    </div>
    <div class="form-group">
    ...
    <a href="forgetpass.jsp" class="btn btn-info btn-sm">Forget Password</a>
  </form>
