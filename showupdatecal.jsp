<%-- 
    Document   : showupdatecal
    Created on : 14 Apr, 2018, 12:29:43 PM
    Author     : HP Laptop
--%>
   ...
   $('.button').click(function(event){
       ...
       if(color === 'rgb(255, 0, 0)'){
         $(event.target).css('background-color', 'green');
          $(event.target).val('VACANT');
       }
       else if(color === 'rgb(0, 128, 0)'){
         $(event.target).css('background-color', 'red');
       $(event.target).val('BOOKED');
        }
   });
...
<nav class="navbar navbar-inverse" data-spy="affix" data-offset-top="197">
  <ul class="nav navbar-nav">
    ...
    <li> <a href="newreq.jsp" >New Requests</a></li>
...
%>
          ...
          <h2>Enter engaged slots according to time-table</h2>
...
<br><button>Confirm Submission</button>
<% }else{ %>
<table>
  <tr>
      <td></td>
...
<tr>
    <td><input type="hidden" value="MONDAY" name="mon">MONDAY</td>
    <td><input type="text" id="" name="b00" value="VACANT" readonly="false" class="button"></td>
    <td><input type="text" id="" name="b01" value="VACANT" readonly="false" class="button"></td>
    <td><input type="text" id="" name="b02" value="VACANT" readonly="false" class="button"></td>
    <td><input type="text" id="" name="b03" value="VACANT"readonly="false" class="button"></td>
    <td><input type="text" id=""name="b04" value="VACANT" readonly="false" class="button"></td>
    <td><input type="text" id="" name="b05" value="VACANT" readonly="false" class="button"></td>
    <td><input type="text" id="" name="b06" value="VACANT"readonly="false" class="button"></td>
    <td><input type="text" id="" name="b07" value="VACANT" readonly="false" class="button"></td>
</tr>
<tr>
    <td><input type="hidden" value="TUESDAY" name="mon">TUESDAY</td>
    <td><input type="text" id="" name="b10" value="VACANT" readonly="false" class="button"></td>
    <td><input type="text" id="" name="b11" value="VACANT" readonly="false" class="button"></td>
    <td><input type="text" id="" name="b12" value="VACANT" readonly="false" class="button"></td>
    <td><input type="text" id="" name="b13" value="VACANT"readonly="false" class="button"></td>
    <td><input type="text" id="" name="b14" value="VACANT" readonly="false" class="button"></td>
    <td><input type="text" id="" name="b15" value="VACANT" readonly="false" class="button"></td>
    <td><input type="text" id="" name="b16" value="VACANT"readonly="false" class="button"></td>
    <td><input type="text" id="" name="b17" value="VACANT" readonly="false" class="button"></td>
</tr>
<tr>
    <td><input type="hidden" value="WEDNESDAY" name="mon">WEDNESDAY</td>
    <td><input type="text" id="" name="b20" value="VACANT" readonly="false" class="button"></td>
    <td><input type="text" id="" name="b21" value="VACANT" readonly="false" class="button"></td>
    <td><input type="text" id="" name="b22" value="VACANT" readonly="false" class="button"></td>
    <td><input type="text" id="" name="b23" value="VACANT"readonly="false" class="button"></td>
    <td><input type="text" id="" name="b24" value="VACANT" readonly="false" class="button"></td>
    <td><input type="text" id="" name="b25" value="VACANT" readonly="false" class="button"></td>
    <td><input type="text" id="" name="b26" value="VACANT"readonly="false" class="button"></td>
    <td><input type="text" id="" name="b27" value="VACANT" readonly="false" class="button"></td>
</tr>
<tr>
    <td><input type="hidden" value="THURSDAY" name="mon">THURSDAY</td>
    <td><input type="text" id="" name="b30" value="VACANT" readonly="false" class="button"></td>
    <td><input type="text" id="" name="b31" value="VACANT" readonly="false" class="button"></td>
    <td><input type="text" id="" name="b32" value="VACANT" readonly="false" class="button"></td>
    <td><input type="text" id="" name="b33" value="VACANT"readonly="false" class="button"></td>
    <td><input type="text" id="" name="b34" value="VACANT" readonly="false" class="button"></td>
    <td><input type="text" id="" name="b35" value="VACANT" readonly="false" class="button"></td>
    <td><input type="text" id="" name="b36" value="VACANT"readonly="false" class="button"></td>
    <td><input type="text" id="" name="b37" value="VACANT" readonly="false" class="button"></td>
</tr>
<tr>
    <td><input type="hidden" value="FRIDAY" name="mon">FRIDAY</td>
   <td><input type="text" id="" name="b40" value="VACANT" readonly="false" class="button"></td>
    <td><input type="text" id="" name="b41" value="VACANT" readonly="false" class="button"></td>
    <td><input type="text" id="" name="b42" value="VACANT" readonly="false" class="button"></td>
    <td><input type="text" id="" name="b43" value="VACANT"readonly="false" class="button"></td>
    <td><input type="text" id="" name="b44" value="VACANT" readonly="false" class="button"></td>
    <td><input type="text" id="" name="b45" value="VACANT" readonly="false" class="button"></td>
    <td><input type="text" id="" name="b46" value="VACANT"readonly="false" class="button"></td>
    <td><input type="text" id="" name="b47" value="VACANT" readonly="false" class="button"></td>
</tr>
</table>
                        ...
                        <div id="footer-content">
                            ...
                            <div class="col-xs-4 col-md-4 text-center">
                                ...
                                <p>08:00 AM - 5:00 PM</p>
                                 <a class="up-arrow" href="showupdatecal.jsp" data-toggle="tooltip" title="TO TOP" >
